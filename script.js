...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=5623049573814f75a9a181747231102&q=" + all_loc[0] + "&days=7")
...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=5623049573814f75a9a181747231102&q=" + all_loc[1] + "&days=7")
  .then(response => response.json())
...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=5623049573814f75a9a181747231102&q=" + all_loc[2] + "&days=7")
  .then(response => response.json())
...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=5623049573814f75a9a181747231102&q=" + all_loc[3] + "&days=7")
  .then(response => response.json())
...
for (let i = 0 ; i < all_loc.length ; i++){
  fetch("https://api.weatherapi.com/v1/current.json?key=5623049573814f75a9a181747231102&q=" + all_loc[i])
  .then(response => response.json())
...
document.querySelector("input").addEventListener("keydown", function(event){
  ...
  fetch("https://api.weatherapi.com/v1/search.json?key=5623049573814f75a9a181747231102&q=" + loca)
  .then(response => response.json())
