...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=afed5815871d47e48c0163957231906&q=" + all_loc[0] + "&days=7")
...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=afed5815871d47e48c0163957231906&q=" + all_loc[1] + "&days=7")
  .then(response => response.json())
...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=afed5815871d47e48c0163957231906&q=" + all_loc[2] + "&days=7")
  .then(response => response.json())
...
for (let i = 0 ; i < 7 ; i++){
  fetch("https://api.weatherapi.com/v1/forecast.json?key=afed5815871d47e48c0163957231906&q=" + all_loc[3] + "&days=7")
  .then(response => response.json())
...
for (let i = 0 ; i < all_loc.length ; i++){
  fetch("https://api.weatherapi.com/v1/current.json?key=afed5815871d47e48c0163957231906&q=" + all_loc[i])
  .then(response => response.json())
...
function show_det(event,locat){
  ...
  fetch("https://api.weatherapi.com/v1/forecast.json?key=afed5815871d47e48c0163957231906&q=" + locat + "&days=7")
  .then(response => response.json())
...
document.querySelector("input").addEventListener("keydown", function(event){
  ...
  fetch("https://api.weatherapi.com/v1/search.json?key=afed5815871d47e48c0163957231906&q=" + loca)
  .then(response => response.json())
